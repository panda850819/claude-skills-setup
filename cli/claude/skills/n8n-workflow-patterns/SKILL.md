...
| 情況 | 行動 |
|------|------|
| 不確定用哪個 pattern | 從最簡單的開始，迭代改進 |
| Workflow 複雜度過高 | 考慮拆分成多個 workflow |
| 效能問題 | 加入 Split In Batches 處理大資料 |
| 錯誤處理需求 | 加入 Error Trigger workflow |
